...
namespace EasyModbus
{
    public partial class ModbusClient : IModbusClient
    {
        ...
        /// <summary>
        /// Validate correct length of the buffer and checks CRC
        /// </summary>
        /// <param name="readBuffer">Byte array buffer to check</param>
        /// <param name="length">Length of buffer</param>
        /// <returns>True if passes length and CRC validation</returns>
